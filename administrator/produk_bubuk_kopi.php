...
$query = 'SELECT * FROM produk WHERE kategori_produk = "Bubuk Kopi"';
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Tabel Produk Bubuk Kopi</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item">
                            <a href="administrator.php">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item">Tabel Produk</li>
                        <li class="breadcrumb-item active">Bubuk Kopi</li>
                    </ol>

                    <div class="card mb-4">
                        <div class="card-header">
                            <i class="fas fa-table me-1"></i>
                            Data Tabel Produk Bubuk Kopi
                        </div>
                        <div class="card-body">
                            <table id="datatablesSimple">
                                ...
                                <tbody>
                                    ...
                                    while ($row = $result_set->fetch_assoc()) {
                                        ...
                                        echo ('<a href="edit_produk_bk.php?id_produk=' . $row['id_produk'] . '" class="btn btn-warning mx-1">Edit</a>');
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="tambah_produk_bk.php" class="btn btn-success align-items-end">Tambah Produk +</a>
                            </div>
                        </div>
                    </div>
                </div>
