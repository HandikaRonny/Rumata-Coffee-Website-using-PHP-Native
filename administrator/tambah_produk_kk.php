        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container">
                    ...
                    <form action="../function/tambah_produk_proses_kk.php" method="POST" enctype="multipart/form-data">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="berat_produk" class="form-control" required>
                        </div>
                        <div class="mb-3">
