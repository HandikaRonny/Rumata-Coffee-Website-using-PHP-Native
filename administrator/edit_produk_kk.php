...
if (isset($_POST['simpan_perubahan'])) {
    ...
    if ($_FILES['gambar_produk']['name']) {
        ...
        $query = "UPDATE produk SET nama_produk = '$nama_produk', kategori_produk = '$kategori_produk', deskripsi_produk = '$deskripsi_produk', harga_produk = '$harga_produk', berat_produk= '$berat_produk', stok_produk = '$stok_produk', gambar_produk = '$gambar_produk' WHERE id_produk = $id_produk";
    } else {
        // Query untuk mengupdate data produk tanpa mengubah gambar
        // Silakan ganti dengan kode query sesuai dengan struktur tabel Anda
        $query = "UPDATE produk SET nama_produk = '$nama_produk', kategori_produk = '$kategori_produk', deskripsi_produk = '$deskripsi_produk', harga_produk = '$harga_produk', berat_produk= '$berat_produk', stok_produk = '$stok_produk' WHERE id_produk = $id_produk";
    }
