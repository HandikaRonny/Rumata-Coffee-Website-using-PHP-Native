...
$query = 'SELECT * FROM produk WHERE kategori_produk = "Kopi Kekinian"';
...
<head>
  ...
  <title>Tabel - Rumata Coffee</title>
    ...
    <div id="layoutSidenav_content">
      <main>
        <div class="container-fluid px-4">
          <h1 class="mt-4">Tabel Produk Kopi Kekinian</h1>
          <ol class="breadcrumb mb-4">
            <li class="breadcrumb-item">
              <a href="administrator.php">Dashboard</a>
            </li>
            <li class="breadcrumb-item">Tabel Produk</li>
            <li class="breadcrumb-item active">Kopi Kekinian</li>
          </ol>

          <div class="card mb-4">
            <div class="card-header">
              <i class="fas fa-table me-1"></i>
              Data Tabel Produk Kopi Kekinian
            </div>
            <div class="card-body">
              <table id="datatablesSimple">
                ...
                <tbody>
                  ...
                  while ($row = $result_set->fetch_assoc()) {
                    ...
                    echo ('<td>' . $row['berat_produk'] . '</td>');
                    echo ('<td>' . $row['stok_produk'] . '</td>');
                    echo ('<td><img src="../img/' . $row['gambar_produk'] . '" class="img-thumbnail" style="max-width: 100px; max-height: 100px;"></td>');
                    echo ('<td>');
                    echo ('<div class="d-flex sub">');
                    echo ('<a href="edit_produk_kk.php?id_produk=' . $row['id_produk'] . '" class="btn btn-warning mx-1">Edit</a>');
                    echo ('<a href="../function/hapus_produk.php?id_produk=' . $row['id_produk'] . '" class="btn btn-danger">Hapus</a>');
                    echo ('</div>');
                    echo ('</td>');
                    echo ('</tr>');
                  }
              ...
              <div class="d-flex justify-content-end">
                <a href="tambah_produk_kk.php" class="btn btn-success align-items-end">Tambah Produk +</a>
              </div>
            </div>
          </div>
        </div>
