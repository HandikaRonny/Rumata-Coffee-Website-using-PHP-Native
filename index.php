...
<body>
  ...
  <div id="demo" class="carousel slide" data-bs-ride="carousel">
    ...
    <div class="carousel-inner">
      <div class="carousel-item active">
        <img src="img/tes(2).jpeg" alt="Rumata Coffee" class="d-block w-100">
      </div>
      <div class="carousel-item">
        <img src="img/tes(3).jpeg" alt="Rumata Coffee" class="d-block w-100">
      </div>
      <div class="carousel-item">
        <img src="img/tes2.jpeg" alt="Rumata Coffee" class="d-block w-100">
      </div>
    </div>
  ...
  <div class="container-fluid bg-img py-5">
    <div class="container">
      ...
      <div class="row gx-5">
        <div class="col-lg-5 mb-5 mb-lg-0" style="min-height: 400px" data-aos="fade-right">
