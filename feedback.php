      ...
      <div class="row justify-content-center">
        <div class="col-lg-6">
          <form action="feedback_process.php" method="POST">
            <div class="row g-3">
              <div class="col-sm-6">
                <input type="text" name="nama" class="form-control bg-light border-0 px-4" placeholder="Nama Kamu" style="height: 55px;">
              </div>
              <div class="col-sm-6">
                <input type="email" name="email" class="form-control bg-light border-0 px-4" placeholder="Email Kamu" style="height: 55px;">
              </div>
              <div class="col-sm-12">
                <input type="text" name="subject" class="form-control bg-light border-0 px-4" placeholder="Subject" style="height: 55px;">
              </div>
              <div class="col-sm-12">
                <textarea name="isi_masukan" class="form-control bg-light border-0 px-4 py-3" rows="4" placeholder="Masukan"></textarea>
              </div>
              <div class="col-sm-12">
